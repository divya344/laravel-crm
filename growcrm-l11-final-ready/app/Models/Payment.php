...
class Payment extends Model
{
    ...
    /**
     * The client that made the payment.
     * ✅ FIX: Most Laravel client tables use “id” as primary key, not “client_id”.
     */
    public function client()
    {
        return $this->belongsTo(Client::class, 'payment_clientid', 'id');
    }

    /**
     * The project related to this payment (if any).
     */
    ...
    /**
     * Display formatted invoice ID — e.g., INV-000123.
     */
    ...
    /**
     * Return a formatted payment date.
     */
    ...
    /**
     * Return formatted payment amount with currency symbol.
     */
    ...
    /**
     * Display formatted payment reference — e.g., PAY-20251109-ABCD12.
     */
